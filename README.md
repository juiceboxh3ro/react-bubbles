...
- [ ] Explain what a token is used for.
  ...
  a token is used for authentication; making sure that requests sent to the server are from an actual user, usually with a randomly generated token

- [ ] What steps can you take in your web apps to keep your data secure?

  private routes, authentication, setting up our server to reject requests that don't have a token generated by us

- [ ] Describe how web servers work.

  the web server receives requests from the user and based on the type of request the server will perform appropriate CRUD operations in the database
